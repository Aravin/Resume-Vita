      ...
      <div className="flex-1">
        <div className="flex gap-6">
          <div className="flex-1 form-control">
            ...
            <input type="text" className={`input input-bordered font-medium ${prop.errors?.name && 'input-error'}`} placeholder="e.g English" {...prop.register(`languages.${prop.index}.name`,)} />
          </div>
          ...
          <div className="flex-1 form-control">
            ...
            <select className={`select select-bordered ${prop.errors?.level && 'input-error'}`} {...prop.register(`languages.${prop.index}.level`,)}>
