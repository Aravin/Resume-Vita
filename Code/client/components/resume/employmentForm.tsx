      ...
      <div className="">
        ...
        <div className="grid grid-cols-3 gap-12">
          ...
          <div className="form-control">
            ...
            <input type="month" className="input input-bordered" placeholder="End Date" defaultValue={prop.endDate} {...prop.register(`employment.${prop.index}.endDate`, {})} />
          </div>
          ...
          <div className="form-control">
            ...
            <input type="text" className="input input-bordered" placeholder="Location" defaultValue={prop.location} {...prop.register(`employment.${prop.index}.location`, {})} />
          </div>
        </div>
